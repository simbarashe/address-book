...
export class LoginComponent implements OnInit {
 ...
 submitForm(value: any){
    ...
    let form = {
      'client_id' : 'KCw7J6WZm7Ore5HiN08GYWNPrGEAwnHb',
    ...
    this.http.post('https://curative-sa.auth0.com/authorize', form).subscribe(
      (res:any)=>{
  ...
  getUserInfo(data: any){
    ...
    this.http.post('https://curative-sa.auth0.com/userinfo', form).subscribe(
      (res:any)=>{
        let data = res.json();
        this.profile = data;
